...
export const buttonClass =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-800 disabled:opacity-60";
...
export function Badge({ className, ...props }: ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "inline-flex rounded-md bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700",
        className,
      )}
      {...props}
    />
